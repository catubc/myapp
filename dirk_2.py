...
class Loadcsv(object):
    ...
    def __init__(self, fname, tsf, work_dir):

        self.fname = fname
        self.loadSpikes(fname, tsf, work_dir)

    def loadSpikes(self, fname, tsf, work_dir):
        ...
        randomized_filename = fname.replace('/home/catubc/webapps/my_django_app/myproject/media/uploads/','')
        randomized_filename = randomized_filename.replace('../static/'+work_dir,'')
        temp_file = '/home/catubc/webapps/my_django_app/myproject/media/saved_uploads/'+work_dir +randomized_filename
        
        print "Saving files to saved_uploads: ", fname, temp_file
        shutil.copy(fname, temp_file)
